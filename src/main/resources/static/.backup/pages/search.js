...
export class WizardPageSearch extends WizardPage {
    ...
    constructor(wizard) {
        ...
        this._deviceClassesDiv = this._pageElement.querySelector("#form-search-device-classes");
    ...
    async showPage() {
        ...
        this._deviceClassesDiv.innerHTML = "";

        let response = await fetch(this._wizard.context.api("deviceClasses"));
        ...
        json._embedded.device_classes.forEach(deviceClass => {
            let id = deviceClass.id;
            let name = deviceClass.name;

            let divElement = document.createElement("div");
            this._deviceClassesDiv.appendChild(divElement);

            divElement.classList.add("form-check");
            divElement.classList.add("form-check-inline");
